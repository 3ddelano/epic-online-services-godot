...
function GodotIcon({ className = "w-4 h-4" }) {
  return (
    <svg
...
function EpicIcon({ className = "w-4 h-4" }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      xmlSpace="preserve"
      ...
      <div className="container px-6 relative z-10 grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="max-w-xl">
          ...
          <div className="flex flex-wrap gap-3 mb-8">
            <span className="glass px-4 py-2 rounded-full flex items-center text-sm font-semibold text-gray-200">
              <GodotIcon className="w-4 h-4 mr-2" />
              Godot 4.2+
            </span>
            <span className="glass px-4 py-2 rounded-full flex items-center text-sm font-semibold text-gray-200">
              <EpicIcon className="w-4 h-4 mr-2" />
              EOS SDK 1.18.1.2
            </span>
          </div>
          ...
          <div className="flex flex-wrap gap-4 mb-10">
            <a
              ...
              className="button-primary px-7 py-3.5 rounded-xl text-sm font-bold uppercase tracking-wider no-underline"
            >
              Download Latest
            </a>
            <a
              href="docs/introduction"
              className="button-secondary px-7 py-3.5 rounded-xl text-sm font-bold uppercase tracking-wider no-underline"
            >
              Documentation
            </a>
          </div>
          ...
          <div className="text-gray-500">
            ...
            <div className="flex flex-wrap gap-2">
              <span className="glass px-3 py-1.5 rounded-full text-xs font-semibold text-gray-300 transition-transform duration-200 hover:scale-105">
                🖥️ Windows x64
              </span>
              <span className="glass px-3 py-1.5 rounded-full text-xs font-semibold text-gray-300 transition-transform duration-200 hover:scale-105">
                🐧 Linux x64/arm64
    ...
    <section id="main-systems" className="py-20 sm:py-24 bg-[#030712] relative">
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          <div
            className="glass rounded-2xl p-8 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-blue-500/5 border-blue-500/20 hover:border-blue-500/40"
            style={{ borderColor: "rgba(59,130,246,0.2)" }}
          >
            <div className="mb-5 w-12 h-12 rounded-xl bg-blue-500/10 flex items-center justify-center">
              <svg
            ...
            <span className="inline-block mb-4 text-xs font-bold uppercase tracking-widest text-blue-400 bg-blue-500/10 px-3 py-1 rounded-full">
              Recommended
            </span>
            ...
            <a
              href="docs/introduction"
              className="inline-flex items-center text-blue-400 hover:text-blue-300 font-semibold text-sm no-underline transition-colors"
            >
              Learn more
              <svg
          ...
          <div
            className="glass rounded-2xl p-8 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-purple-500/5 border-purple-500/20 hover:border-purple-500/40"
            style={{ borderColor: "rgba(168,85,247,0.2)" }}
          >
            <div className="mb-5 w-12 h-12 rounded-xl bg-purple-500/10 flex items-center justify-center">
              <svg
            ...
            <span className="inline-block mb-4 text-xs font-bold uppercase tracking-widest text-purple-400 bg-purple-500/10 px-3 py-1 rounded-full">
              Advanced
            </span>
            <p className="text-gray-400 mb-4 font-light leading-relaxed">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="flex items-center flex-col">
            ...
            <img
              ...
              className="w-full max-w-[800px] h-auto mb-4 rounded-xl glass border-white/10 hover:brightness-110 transition-all duration-300"
            />
            <img
...
function NavBar() {
  return (
    <nav className="fixed top-0 left-0 right-0 z-[100] glass py-4 px-6 h-16">
      <div className="container mx-auto flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-8">
          <a
            href="docs/introduction"
            className="text-gray-400 hover:text-white text-sm font-semibold uppercase tracking-wider transition-colors no-underline"
          >
            Docs
          </a>
          <a
          ...
          <a
            ...
            className="button-secondary px-4 py-2 rounded-lg text-xs font-bold uppercase tracking-widest no-underline flex items-center gap-2"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="w-4 h-4"
