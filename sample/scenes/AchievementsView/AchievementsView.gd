...
func _ready() -> void:
	EOS.get_instance().achievements_interface_achievements_unlocked_v2_callback.connect(_on_achievements_interface_achievements_unlocked_v2_callback)
	EOS.get_instance().achievements_interface_unlock_achievements_callback.connect(_on_achievements_interface_unlock_achievements_callback)
...
func _query_achievements():
	...
	print("--- Achievements: query_definitions_callback: ", EOS.result_str(await EOS.get_instance().achievements_interface_query_definitions_callback))
	...
	print("--- Achievements: query_player_achievements_callback: ", EOS.result_str(await EOS.get_instance().achievements_interface_query_player_achievements_callback))
