...
void IEOS::_bind_methods() {
    ...
    ADD_SIGNAL(MethodInfo("ecom_interface_query_entitlement_token_callback", PropertyInfo(Variant::DICTIONARY, "callback_data")));
    ...
    ADD_SIGNAL(MethodInfo("ecom_interface_query_ownership_by_sandbox_ids_callback", PropertyInfo(Variant::DICTIONARY, "callback_data")));
